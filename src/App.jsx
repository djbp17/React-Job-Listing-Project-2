...
const App = () => {
  return (
    <>
      <Navbar />
      {/* <!-- Hero --> */}
      {/* What ever we pass here or in the main Component, it will always override the value of title(title is example below) in the Hero components. Just like in the example below */}
      {/* <Hero title="This is a title" subtitle="This is a subtitle whoooo" /> */}
      <Hero />
      <HomeCards />
